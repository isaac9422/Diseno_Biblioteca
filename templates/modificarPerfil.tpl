...
<html>
    ...
    <body>
        <form action="{$gvar.l_global}modificarPerfil.php" method="post">
            <b class="etiq">Contraseña actual :</b><input class="campos" type="password" name="password" value="" /><br> 
            ...
            <input class="campos" type="hidden" name="emailOld" value="{$objeto->get('email')}" />
